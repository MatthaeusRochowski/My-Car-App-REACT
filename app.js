...
mongoose
  .connect(process.env.MONGODB_URI || 'mongodb://localhost/my-car-app-react', {useNewUrlParser: true})
  .then(x => {
...
const logbookApiRoutes = require('./routes/logbook');
app.use('/api/logbook', logbookApiRoutes);
